...
//std::vector<std::vector<int64_t>> generate_input_ids(ONNXModel & model, std::vector<float>& mel, int length, int step=0,
...
//    }
//    input_ids[7] = new std::vector<int64_t>{_input_t, std::vector<int64_t>(length, _pad_t), _eot, _answer_t};
//    return input_ids;
//}
